...
const Sidebar = ({ className }) => {
  ...
  return (
    <div className={`bsidebar ${className || ''}`}>
      <nav className="sidebar-menu">
        <Link to="/livreur" className="stylenone">
          <div className={`menu-item ${location.pathname.includes('/livreur/tasks') ? 'active' : ''}`}>
            <svg
      ...
      {livreurId && (
        <div className={`notifications-panel ${!showNotifications ? 'hidden' : ''}`}>
          <NotificationsPanel 
            livreurId={livreurId} 
