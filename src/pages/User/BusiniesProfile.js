...
import BusinessTaskDashboard from "../../COMPONENTS/Business/BusinessTasksDashboard";
      ...
      <div className="userprofilein">
        ...
        {user && (
          <div className="right">
            ...
            {activepage === "affectertaches" && <BusinessTaskDashboard />}
            ...
            {activepage === "analytics" && <AnalysisComponent />}
          </div>
        )}
      </div>
